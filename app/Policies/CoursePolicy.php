...
class CoursePolicy
{
    ...
    {
        // Permitir que cualquier usuario autenticado vea cualquier curso
        return auth()->check();
    }
    ...
    {
        // Permitir que el usuario vea el curso si es el instructor o si está autenticado
        return $user->id === $course->instructor_id || auth()->check();
    }
