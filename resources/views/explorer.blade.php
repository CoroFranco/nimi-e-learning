<x-appLayout>
    ...
    <main class="max-w-[1400px] w-[90%] m-auto p-6 md:p-8 lg:p-12 bg-white">
        <h1 class="text-6xl font-bold mb-8 text-[var(--text-color)]">Explorar Cursos</h1>
                                ...
                                <div class="space-y-2  overflow-y-auto">
                                    @foreach($categories as $category)
                                        <label class="flex items-center space-x-2">
                                            ...
                                            <span class="text-2xl text-[var(--text-color)]">{{ $category->name }}</span>
                                        </label>
                                    @endforeach
                                </div>
                            </div>
                            <div>
                                ...
                                @foreach(['Beginner', 'Intermediate', 'Advanced'] as $level)
                                    <label class="flex items-center space-x-2">
                                        ...
                                        <span class="text-2xl text-[var(--text-color)]">{{ $level }}</span>
                                    </label>
                                @endforeach
                            </div>
                            <div class="">
                                ...
                                <div class="flex flex-wrap space-x-4 place-items-center">
                                    <input type="number" name="min_price" placeholder="Min" class="w-32 px-2 py-4 rounded-md bg-[var(--input-bg)] text-[var(--text-color)] border border-[var(--border-color)]">
                                    <span class="text-[var(--text-color)]">-</span>
                                    <input type="number" name="max_price" placeholder="Max" class="w-32 px-2 py-4 rounded-md bg-[var(--input-bg)] text-[var(--text-color)] border border-[var(--border-color)]">
                                </div>
                            </div>
