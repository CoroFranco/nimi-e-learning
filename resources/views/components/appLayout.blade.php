    ...
    <div class="flex flex-col md:flex-row flex-grow">
        ...
        <aside class="w-full md:block md:w-[24rem] items-center flex flex-col md:pl-8 shadowNav z-10">
            <div class="md:p-4 pt-2 ">
                <a class="flex justify-center md:justify-start" href="/"><img src="/img/Logo.png" alt="Nimi logo" class="w-[150px] md:w-[120px] md:my-5"></a>
            </div>
            <nav class="text-[1.3rem] sm:text-[1.6rem] mt-8 grid grid-cols-3  md:place-items-left md:block [&>a]:mb-4 [&>a]:gap-2 [&>a]:flex-col [&>a]: md:[&>a]:flex-row [&>a]:flex [&>a]:items-center [&>a]:px-4 [&>a]:py-2 [&>a]:text-[var(--text-color)] [&>a:hover]:text-[var(--hover-color)]">
                <a href="/home" >
                ...
                <a href="{{route('profile')}}" >
                    ...
                    <div class="flex flex-col md:flex-row py-[0.5rem] pl-[1rem] gap-2 hover:text-[var(--hover-color)] mb-[1rem]">
                        ...
                        <form class="flex place-items-center" action="{{ route('logout') }}" method="post">
                            @csrf
